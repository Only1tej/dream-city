...
const SampleFirst = ({ onSubmit }) => {
    ...
    return (
        ...
        <div className='flex flex-row md:flex md:flex-row max-h-screen overflow-auto'>
                    ...
                    <div className="hero min-h-screen bg-white">
                        <div>
                            ...
                            <div className="form-control grid grid-cols-2 gap-4">
                                ...
                                <button className="btn font-primary text-base normal-case bg-[#118286] outline-none border-none hover:bg-[#118286] text-white mt-[221px]" type='submit'>Add Listing</button>
                                ...
                                <button className="btn font-primary text-base font-semibold normal-case bg-white outline outline-[#118286] border-none hover:bg-white text-[#118286] mt-[221px]" >Cancel</button>
                            </div>
                        </div>
                    </div>
                </form>
